// Standalone Vanilla version of the cost database library.

/* The IIFE keeps helpers private while exposing the single required window.db entry point.
   Database selection remains instance-bound through openCostsDB closures. */
(function () {
    ...
    // Vanilla embeds conversion because a classic script cannot import the module helper.
    function convertCurrency(amount, fromCurrency, toCurrency, rates) {
        /* Rates are relative to USD, so conversion divides by the source rate to reach
           USD and multiplies by the target rate to reach the requested currency. */
    ...
    // The factory is the Vanilla library's only exposed capability.
    const db = {
        openCostsDB
    };
